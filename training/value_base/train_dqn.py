...
from agent.value_base.dqn import DiscreteActionDQN


def train_dqn(args: argparse.Namespace, env_info: dict, seed: int, device: torch.device, logger: logging.Logger):
    ...
    agent = DiscreteActionDQN(name=args.model_name,
